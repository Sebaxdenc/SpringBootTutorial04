...
public class ProductController {
    ...
    private static final List<Map<String, String>> products = new ArrayList<>(List.of(
        ...
        Map.of("id", "2", "name", "iPhone", "description", "Best iPhone", "price", "1299.99"),
        Map.of("id", "3", "name", "Chromecast", "description", "Best Chromecast", "price", "39.99"),
        Map.of("id", "4", "name", "Glasses", "description", "Best Glasses", "price", "129.99")
    ));
    ...
    public String save(@Valid @ModelAttribute("productForm") ProductForm productForm, BindingResult result, Model model) {
        ...
        newProduct.put("description", "New product: " + productForm.getName());
    ...
    public String created(Model model) {
        model.addAttribute("title", "Product Created - Online Store");
